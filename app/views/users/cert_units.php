                ...
                <table id="datatablesSimple">
                    ...
                    <?php foreach ($data['certificates'] as $certificate):?>
                        <tr>
                            ...
                            <td class="text-center"><a class="btn btn-primary btn-sm rounded-pill" href="<?php echo URLROOT . "/users/generate_cert_units/" . $certificate->id?>"><i class="fas fa-file-alt"></i></a></td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
                </table>
